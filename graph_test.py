...
class TestMyModule(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph.add_citylist(list_of_cities)
    ...
    def test_no_city_present(self):
        self.assertRaises(NameError("Destination City not present"), self.graph.addconnection("Sevilla", "Granada"))
